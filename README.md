...
<details>
  ...
  <div align="center">
    <h3>💻 My Typing Streak on Monkeytype</h3>
    <p><b>Current Streak:</b> 100+ Days 🖋️</p>
    <!-- Real-time streak chart -->
    <div id="monkeytype_chart" style="width: 100%; height: 500px;"></div>

    <p><i><a href="https://monkeytype.com/profile/coder_neha" target="_blank">View My Typing Progress on Monkeytype!</a></i></p>
  </div>
</details>

<!-- Google Charts script for real-time streak chart -->
...
<script type="text/javascript">
  ...
  function drawChart() {
    ...
    // Adding some sample data. You can replace this with real-time data.
    data.addRows([
      [new Date(2025, 0, 1), 90],
      [new Date(2025, 0, 2), 91],
      [new Date(2025, 0, 3), 92],
      [new Date(2025, 0, 4), 93],
      [new Date(2025, 0, 5), 94],
      [new Date(2025, 0, 6), 95],
      [new Date(2025, 0, 7), 96]
    ]);

    var options = {
      title: 'My Monkeytype Typing Streak',
      curveType: 'function',
      legend: { position: 'bottom' },
      vAxis: { title: 'Streak (Days)' },
      hAxis: { title: 'Date' },
      backgroundColor: 'transparent',
    };

    var chart = new google.visualization.LineChart(document.getElementById('monkeytype_chart'));
